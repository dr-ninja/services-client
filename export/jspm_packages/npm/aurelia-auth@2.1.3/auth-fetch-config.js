/* */ 
define(['exports', 'aurelia-dependency-injection', 'aurelia-fetch-client', './authentication', 'isomorphic-fetch'], function (exports, _aureliaDependencyInjection, _aureliaFetchClient, _authentication) {
  'use strict';
