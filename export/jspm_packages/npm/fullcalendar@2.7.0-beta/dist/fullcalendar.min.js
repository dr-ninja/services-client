  ...
  !function(a) {
    ...
    function d(b) {
      ...
      return a.each(b, function(b, e) {
        "views" != b && (a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Va) ? (c = null, a.each(e, function(a, e) {
    ...
    function v(a) {
      ...
      return b && 1 == b.length ? b[0].pageX : void 0;
    }
    function w(a) {
      if (void 0 !== a.pageY)
        return a.pageY;
      var b = a.originalEvent.touches;
      return b && 1 == b.length ? b[0].pageY : void 0;
    }
    function x(a) {
    ...
    function Q(a, c) {
      var d;
      return R(a) ? b.duration(a * c) : (d = a.asMonths(), Math.abs(d) >= 1 && fa(d) ? b.duration({months: d * c}) : b.duration({days: a.asDays() * c}));
    }
    function R(a) {
    ...
    function ja(a, c) {
      var d,
          ...
          i = [];
      for (d = 0; h > d; d++)
        e = a[d], b.isMoment(e) || (e = Ta.moment.parseZone(e)), f = f || e._ambigTime, g = g || e._ambigZone, i.push(e);
      for (d = 0; h > d; d++)
    ...
    function ua(a) {
      for (var b,
        ...
        b[1] ? c.push(b[1]) : b[2] ? c.push({maybe: ua(b[2])}) : b[3] ? c.push({token: b[3]}) : b[5] && c.push(b[5]);
      return c;
    }
    function va() {}
    function wa(a, b) {
    ...
    function Na(c, d) {
      ...
      function f() {
        U = O.theme ? "ui" : "fc", c.addClass("fc"), c.addClass(Ta.isTouchEnabled ? "fc-touch" : "fc-cursor"), O.isRTL ? c.addClass("fc-rtl") : c.addClass("fc-ltr"), O.theme ? c.addClass("ui-widget") : c.addClass("fc-unthemed"), T = a("<div class='fc-view-container'/>").prependTo(c), R = N.header = new Qa(N, O), S = R.render(), S && c.prepend(S), i(O.defaultView), O.handleWindowResize && (Y = ha(m, O.windowResizeDelay), a(window).resize(Y));
      }
      function g() {
      ...
      function i(b) {
        ca++, W && b && W.type !== b && (R.deactivateButton(W.type), H(), W.removeElement(), W = N.view = null), !W && b && (W = N.view = ba[b] || (ba[b] = N.instantiateView(b)), W.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(T)), R.activateButton(b)), W && (Z = W.massageCurrentDate(Z), W.displaying && Z.isWithin(W.intervalStart, W.intervalEnd) || h() && (W.display(Z), I(), u(), v(), q())), I(), ca--;
      }
      function j(a) {
    ...
    function Ra(c) {
      ...
      function g(b, d) {
        ...
        for (e = 0; e < h.length; e++) {
          if (f = h[e].call(H, b, I.clone(), M.clone(), c.timezone, d), f === !0)
            return;
          if ("object" == typeof f)
            return void g(f, d);
        }
        var i = b.events;
        if (i)
          a.isFunction(i) ? (H.pushLoading(), i.call(H, I.clone(), M.clone(), c.timezone, function(a) {
            d(a), H.popLoading();
          })) : a.isArray(i) ? d(i) : d();
        else {
          var j = b.url;
      ...
      function m(a) {
        a.start = H.moment(a.start), a.end ? a.end = H.moment(a.end) : a.end = null, x(a, n(a)), N(S);
      }
      function n(b) {
        var c = {};
        return a.each(b, function(a, b) {
          o(a) && void 0 !== b && Z(b) && (c[a] = b);
        }), c;
      }
      function o(a) {
      ...
      function s(d, e) {
        var f,
            ...
            h,
            i = {};
        if (c.eventDataTransform && (d = c.eventDataTransform(d)), e && e.eventDataTransform && (d = e.eventDataTransform(d)), a.extend(i, d), e && (i.source = e), i._id = d._id || (void 0 === d.id ? "_fc" + Bb++ : d.id + ""), d.className ? "string" == typeof d.className ? i.className = d.className.split(/\s+/) : i.className = d.className : i.className = [], f = d.start || d.date, g = d.end, T(f) && (f = b.duration(f)), T(g) && (g = b.duration(g)), d.dow || b.isDuration(f) || b.isDuration(g))
          i.start = f ? b.duration(f) : null, i.end = g ? b.duration(g) : null, i._recurring = !0;
        else {
          if (f && (f = H.moment(f), !f.isValid()))
            return !1;
          g && (g = H.moment(g), g.isValid() || (g = null)), h = d.allDay, void 0 === h && (h = _(e ? e.allDayDefault : void 0, c.allDayDefault)), t(f, g, h, i);
        }
        return i;
      }
      function t(a, b, c, d) {
    ...
    var Ta = a.fullCalendar = {
      ...
      internalApiVersion: 3
        ...
        Ua = Ta.views = {};
    Ta.isTouchEnabled = "ontouchstart" in document && !window.__karma__, a.fn.fullCalendar = function(b) {
    ...
    var Va = ["header", "buttonText", "buttonIcons", "themeButtonIcons"];
    Ta.intersectRanges = I, Ta.applyAll = $, Ta.debounce = ha, Ta.isInt = fa, Ta.htmlEscape = aa, Ta.cssToStr = ca, Ta.proxy = ga, Ta.capitaliseFirstLetter = da, Ta.getOuterRect = n, Ta.getClientRect = o, Ta.getContentRect = p, Ta.getScrollbarWidths = q;
    var Wa = null;
    Ta.preventDefault = z, Ta.intersectRects = A, Ta.parseFieldSpecs = E, Ta.compareByFieldSpecs = F, Ta.compareByFieldSpec = G, Ta.flexibleCompare = H, Ta.computeIntervalUnit = M, Ta.divideRangeByDuration = O, Ta.divideDurationByDuration = P, Ta.multiplyDuration = Q, Ta.durationHasTime = R;
    ...
    Ta.moment = function() {
      ...
      if (!this._fullCalendar)
        return eb.time.apply(this, arguments);
      if (null == a)
        return b.duration({
          hours: this.hours(),
    ...
    var gb = {
      ...
      s: "second"
        ...
        hb = {};
    Ta.Class = va, va.extend = function() {
      var a,
          b,
          c = arguments.length;
      for (a = 0; c > a; a++)
        b = arguments[a], c - 1 > a && xa(this, b);
      return wa(this, b || {});
    }, va.mixin = function(a) {
      xa(this, a);
    };
        ...
        mb = Ta.DragListener = va.extend(jb, {
          ...
          bindHandlers: function() {
            ...
            this.isTouch ? this.listenTo(a(document), {
              ...
              selectstart: z,
              contextmenu: z
            }), this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleScroll);
          },
          ...
          handleScroll: function(a) {
            this.isTouch && !this.isDragging && this.endInteraction(a);
          },
    ...
    mb.mixin({
      ...
      initAutoScroll: function() {
        var a = this.scrollEl;
        this.isAutoScroll = this.options.scroll && a && !a.is(window) && !a.is(document), this.isAutoScroll && this.listenTo(a, "scroll", ha(this.handleDebouncedScroll, 100));
      },
      ...
      setScrollVel: function(a, b) {
        this.scrollTopVel = a, this.scrollLeftVel = b, this.constrainScrollVel(), !this.scrollTopVel && !this.scrollLeftVel || this.scrollIntervalId || (this.scrollIntervalId = setInterval(ga(this, "scrollIntervalFunc"), this.scrollIntervalMs));
      },
    ...
    var nb = mb.extend({
      ...
      constructor: function(a, b) {
        mb.call(this, b), this.component = a;
      },
      handleInteractionStart: function(a) {
        var b,
            c,
            d,
            e = this.subjectEl;
        mb.prototype.handleInteractionStart.apply(this, arguments), this.computeCoords(), a ? (c = {
          left: v(a),
          top: w(a)
      ...
      handleInteractionEnd: function() {
        mb.prototype.handleInteractionEnd.apply(this, arguments), this.origHit = null, this.hit = null, this.component.releaseHits();
      },
      handleScrollEnd: function() {
        mb.prototype.handleScrollEnd.apply(this, arguments), this.computeCoords();
      },
      queryHit: function(a, b) {
        ...
        pb = Ta.Grid = va.extend(jb, {
          ...
          setElement: function(a) {
            this.el = a, y(a), Ta.isTouchEnabled ? this.bindDayHandler("touchstart", this.dayTouchStart) : this.bindDayHandler("mousedown", this.dayMousedown), this.bindSegHandlers(), this.bindGlobalHandlers();
          },
          ...
          dayTouchStart: function(a) {
            this.clearDragListeners(), this.buildDayDragListener().startInteraction(a, {delay: this.view.opt("longPressDelay")});
          },
            ...
            var a,
                ...
                f = this.dayDragListener = new nb(this, {
                  ...
                  hitOver: function(d, f, h) {
                    h && (a = f ? d : null, e && (b = c.computeSelection(c.getHitSpan(h), c.getHitSpan(d)), b ? c.renderSelection(b) : b === !1 && g()));
                  },
                  hitOut: function() {
                    a = null, b = null, c.unrenderSelection(), h();
                  },
                  interactionEnd: function(e) {
                    a && d.triggerDayClick(c.getHitSpan(a), c.getHitEl(a), e), b && d.reportSelection(b, e), h(), c.dayDragListener = null;
                  }
                });
            return f;
          },
    ...
    pb.mixin({
      ...
      bindSegHandlers: function() {
        Ta.isTouchEnabled ? this.bindSegHandler("touchstart", this.handleSegTouchStart) : (this.bindSegHandler("mouseenter", this.handleSegMouseover), this.bindSegHandler("mouseleave", this.handleSegMouseout), this.bindSegHandler("mousedown", this.handleSegMousedown)), this.bindSegHandler("click", this.handleSegClick);
      },
      ...
      handleSegTouchStart: function(a, b) {
        var c,
            ...
            g = !1;
        f && (g = this.startSegResize(a, b)), !g && d.isEventDraggable(e) && (this.clearDragListeners(), c = this.buildSegDragListener(a), c._dragStart = function() {
          f || d.selectEvent(e);
      ...
      handleSegMousedown: function(a, b) {
        ...
        !c && this.view.isEventDraggable(a.event) && (this.clearDragListeners(), this.buildSegDragListener(a).startInteraction(b, {distance: 5}));
      },
      startSegResize: function(b, c, d) {
        return a(c.target).is(".fc-resizer") && this.view.isEventResizable(b.event) ? (this.clearDragListeners(), this.buildSegResizeListener(b, a(c.target).is(".fc-start-resizer")).startInteraction(c, d), !0) : !1;
      },
      ...
      invertRanges: function(a) {
        var b,
            ...
            g = [],
            h = e;
        for (a.sort(Ea), b = 0; b < a.length; b++)
    ...
    }), Ta.isBgEvent = Aa, Ta.dataAttrPrefix = "";
    ...
    rb.mixin({
      rowStructs: null,
      unrenderEvents: function() {
        this.removeSegPopover(), pb.prototype.unrenderEvents.apply(this, arguments);
      },
      getEventSegs: function() {
    ...
    var sb = Ta.TimeGrid = pb.extend(qb, {
      ...
      constructor: function() {
        pb.apply(this, arguments), this.processOptions();
      },
      renderDates: function() {
      ...
      renderSlatRowHtml: function() {
        for (var a,
          ...
          a = this.start.clone().time(h), c = fa(P(h, this.labelInterval)), d = '<td class="fc-axis fc-time ' + e.widgetContentClass + '" ' + e.axisStyleAttr() + ">" + (c ? "<span>" + aa(a.format(this.labelFormat)) + "</span>" : "") + "</td>", g += '<tr data-time="' + a.format("HH:mm:ss") + '"' + (c ? "" : ' class="fc-minor"') + ">" + (f ? "" : d) + '<td class="' + e.widgetContentClass + '"/>' + (f ? d : "") + "</tr>", h.add(this.slotDuration);
        return g;
      },
      ...
      computeLabelInterval: function(a) {
        ...
        for (c = Jb.length - 1; c >= 0; c--)
          if (d = b.duration(Jb[c]), e = P(d, a), fa(e) && e > 1)
            return d;
        return b.duration(a);
      },
      computeEventTimeFormat: function() {
    ...
    var tb = Ta.View = va.extend(ib, jb, {
      ...
      constructor: function(a, c, d, e) {
        this.calendar = a, this.type = this.name = c, this.options = d, this.intervalDuration = e || b.duration(1, "day"), this.nextDayThreshold = b.duration(this.opt("nextDayThreshold")), this.initThemingProps(), this.initHiddenDays(), this.isRTL = this.opt("isRTL"), this.eventOrderSpecs = E(this.opt("eventOrder")), this.initialize();
      },
      initialize: function() {},
      opt: function(a) {
      ...
      handleDocumentMousedown: function(a) {
        !Ta.isTouchEnabled && u(a) && (this.processRangeUnselect(a), this.processEventUnselect(a));
      },
        ...
        vb = Ta.Calendar = va.extend({
          ...
          initOptions: function(a) {
            var b,
                ...
                f,
                g;
            a = d(a), b = a.lang, e = wb[b], e || (b = vb.defaults.lang, e = wb[b] || {}), f = _(a.isRTL, e.isRTL, vb.defaults.isRTL), g = f ? vb.rtlDefaults : {}, this.dirDefaults = g, this.langDefaults = e, this.overrides = a, this.options = c([vb.defaults, g, e, a]), Oa(this.options), this.viewSpecCache = {};
          },
          ...
          buildViewSpec: function(a) {
            for (var d,
                ...
                k = [],
                l = a; l; )
              d = Ua[l], e = h[l], l = null, "function" == typeof d && (d = {"class": d}), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), e && (k.unshift(e), f = f || e.duration, l = l || e.type);
          ...
          buildViewSpecOptions: function(a) {
            a.options = c([vb.defaults, a.defaults, this.dirDefaults, this.langDefaults, this.overrides, a.overrides]), Oa(a.options);
          },
          buildViewSpecButtonText: function(a, b) {
            ...
            a.buttonTextOverride = c(this.overrides) || a.overrides.buttonText, a.buttonTextDefault = c(this.langDefaults) || c(this.dirDefaults) || a.defaults.buttonText || c(vb.defaults) || (a.duration ? this.humanizeDuration(a.duration) : null) || b;
          },
    ...
    vb.mixin(ib), vb.defaults = {
      ...
      longPressDelay: 1e3
    }, vb.englishDefaults = {dayPopoverFormat: "dddd, MMMM D"}, vb.rtlDefaults = {
      header: {
    ...
    Ta.datepickerLang = function(b, c, d) {
      var e = wb[b] || (wb[b] = {});
      e.isRTL = d.isRTL, e.weekNumberTitle = d.weekHeader, a.each(xb, function(a, b) {
        e[a] = b(d);
    ...
    var Cb = Ta.BasicView = tb.extend({
      ...
      setRange: function(a) {
        tb.prototype.setRange.call(this, a), this.dayGrid.breakOnWeeks = /year|month|week/.test(this.intervalUnit), this.dayGrid.setRange(a);
      },
      computeRange: function(a) {
        var b = tb.prototype.computeRange.call(this, a);
    ...
    var Fb = Ta.AgendaView = tb.extend({
      ...
      bottomRuleEl: null,
      initialize: function() {
        this.timeGrid = this.instantiateTimeGrid(), this.opt("allDaySlot") && (this.dayGrid = this.instantiateDayGrid()), this.scroller = new ub({
          overflowX: "hidden",
          overflowY: "auto"
        });
      },
      ...
      setRange: function(a) {
        tb.prototype.setRange.call(this, a), this.timeGrid.setRange(a), this.dayGrid && this.dayGrid.setRange(a);
      },
      renderDates: function() {
      ...
      setHeight: function(a, b) {
        var c,
            d,
            g;
        this.bottomRuleEl.hide(), this.scroller.clear(), f(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), c = this.opt("eventLimit"), c && "number" != typeof c && (c = Ib), c && this.dayGrid.limitRows(c)), b || (d = this.computeScrollerHeight(a), this.scroller.setHeight(d), g = this.scroller.getScrollbarWidths(), (g.left || g.right) && (e(this.noScrollRowEls, g), d = this.computeScrollerHeight(a), this.scroller.setHeight(d)), this.scroller.lockOverflow(g), this.timeGrid.getTotalSlatHeight() < d && this.bottomRuleEl.show());
      },
      computeScrollerHeight: function(a) {
        return a - l(this.el, this.scroller.el);
      },
